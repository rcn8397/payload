...
\author{Carson~Clanton,~\IEEEmembership{Member,~Phi Mu Epsilon,}
        Kevin~Hayes,
        William~Hunter,
        Richard~Meth,
        and~Ryan~Nordeen}% <-this % stops a space
%\thanks{M. O'Dell is with the Department
%of Computer Science and Engineering, The University of Texas at Arlington, Arlington,
%TX, 79019 USA e-mail: (see http://ranger.uta.edu/~odell).}}% <-this % stops a space
...
\begin{IEEEkeywords}
UDP, Reliable, Error-Correcting Codes, Sequence Numbers.
\end{IEEEkeywords}
...
\IEEEPARstart{W}{hen} a software engineer begins designing a
...
%\begin{figure}[h!]
\centering
\includegraphics[scale=0.5]{PNGs/figure1_1_comm_link}
...
decoder will incorrectly pass the message ÒYESÓ to the receiver.
One way of improving the situation is to add redundancy by
repeating the symbol.  For instance, we might encode ``YES''
as the codeword 11 and ``NO'' as 00.  Now if ÒNOÓ is sent,
